...
<%--<form id="file_upload_id"  name="file_upload_name"--%>
    ...
    <%--&lt;%&ndash;<button id="excel">明细</button>&ndash;%&gt;--%>
    ...
    <%--<div class="col-md-12 col-sm-12 col-xs-12">--%>
        <%--<div class="x_panel">--%>
            ...
            <%--<div style="position: absolute;margin-left: 28%;width: 45%">--%>
                <%--&lt;%&ndash;所有执行：<span id="countAll"></span>&nbsp;&ndash;%&gt;--%>
                <%--今日执行：<span id="countByDay"></span>&nbsp;--%>
                <%--未执行：<span id="notCount"></span>&nbsp;--%>
                <%--&lt;%&ndash;一共领取新人首单和风控中：<span id="byCount1"></span>&nbsp;&ndash;%&gt;--%>
                <%--&lt;%&ndash;今天领取新人首单和风控中：<span id="byCount"></span>&nbsp;&ndash;%&gt;--%>
                <%--&lt;%&ndash;领取新人首单：<span id="listSize"></span>&nbsp;&ndash;%&gt;--%>
                <%--&lt;%&ndash;风控中：<span id="listSize1"></span>&ndash;%&gt;--%>
            <%--</div>--%>
