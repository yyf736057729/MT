...
public class SunCallable implements Callable<Boolean> {
    ...
    public SunCallable(int pageIndex, List<String> list, MongoTemplate mongoTemplate, RedisTemplate redisTemplate,MtSenderService mtSenderService){
    ...
    public Boolean call() throws Exception {
        ...
        System.out.println("{MQ-send:"+Common.MQSEND++ +"}");
        mtSenderService.sendUploadPhone(phones1);
        return result;
    }
}