...
//	 * @param memo
	 */
//	public static void sendMessageToResultPage(HttpServletResponse response,
//                                               boolean status, String returnUrl, String memo) throws IOException {
//
//		String resultUrl = "/admin/result.htm";
//		StringBuilder sb = new StringBuilder();
//		sb.append("?returnUrl=");
//		sb.append(URLEncoder.encode(
//				new String(Base64.encodeBase64(returnUrl.getBytes())), "UTF-8"));
//		sb.append("&status=");
//		sb.append(status);
//		sb.append("&memo=");
//		sb.append(URLEncoder.encode(
